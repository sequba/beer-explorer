  ...
  template: `
    <div class="row">
      ...
      <div class="col-10 col-sm-9 col-lg-10">
        ...
        <p>
          <span class="mr-3"><span class="font-weight-bold">IBU:</span> {{ beer!.ibu }}</span>
          <span class="mr-3"><span class="font-weight-bold">ABV:</span> {{ beer!.abv }}</span>
          <span class="mr-3"><span class="font-weight-bold">EBC:</span> {{ beer!.ebc }}</span>
        </p>
